...
////////////////////////////////////////////////////////////////////////////////
sha256::sha256(const char* data):m_data(data){
    init();
}

void sha256::reset(const char* data) {
    m_data = data;
    init();
}
...
const unsigned char* sha256::digest(void) {
    //transform()
...
void sha256::transform(const std::uint32_t* chunk, size_t blocks) {
    while (blocks--) {
        ...
        TRANSFORM(a, b, c, d, e, f, g, h, 0x428a2f98, w0 = *(chunk++), t);
        TRANSFORM(h, a, b, c, d, e, f, g, 0x71374491, w1 = *(chunk++), t);
        TRANSFORM(g, h, a, b, c, d, e, f, 0xb5c0fbcf, w2 = *(chunk++), t);
        TRANSFORM(f, g, h, a, b, c, d, e, 0xe9b5dba5, w3 = *(chunk++), t);
        TRANSFORM(e, f, g, h, a, b, c, d, 0x3956c25b, w4 = *(chunk++), t);
        TRANSFORM(d, e, f, g, h, a, b, c, 0x59f111f1, w5 = *(chunk++), t);
        TRANSFORM(c, d, e, f, g, h, a, b, 0x923f82a4, w6 = *(chunk++), t);
        TRANSFORM(b, c, d, e, f, g, h, a, 0xab1c5ed5, w7 = *(chunk++), t);
        TRANSFORM(a, b, c, d, e, f, g, h, 0xd807aa98, w8 = *(chunk++), t);
        TRANSFORM(h, a, b, c, d, e, f, g, 0x12835b01, w9 = *(chunk++), t);
        TRANSFORM(g, h, a, b, c, d, e, f, 0x243185be, w10 = *(chunk++), t);
        TRANSFORM(f, g, h, a, b, c, d, e, 0x550c7dc3, w11 = *(chunk++), t);
        TRANSFORM(e, f, g, h, a, b, c, d, 0x72be5d74, w12 = *(chunk++), t);
        TRANSFORM(d, e, f, g, h, a, b, c, 0x80deb1fe, w13 = *(chunk++), t);
        TRANSFORM(c, d, e, f, g, h, a, b, 0x9bdc06a7, w14 = *(chunk++), t);
        TRANSFORM(b, c, d, e, f, g, h, a, 0xc19bf174, w15 = *(chunk++), t);
